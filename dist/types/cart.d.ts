...
export interface ICart {
    ...
    totalItems: number;
    subtotal: number;
    addItem(productId: Types.ObjectId | string, quantity: number, price: number): Promise<ICart>;
    updateItemQuantity(productId: Types.ObjectId | string, quantity: number): Promise<ICart>;
